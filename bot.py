...
def start_command(client, message):
    ...
    logger.info(f'Start button has been clicked by the user  abcd {user_id}')
    bot.send_message(user_id, f" Hello and Welcome to my bot this is yeshpal !!! final test with release and tag  /n  You're using version {RELEASE_TAG}  {user_id}")
